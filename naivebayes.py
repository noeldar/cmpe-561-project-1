...
class naivebayes:
    ...
    def predict(self, X_test, X_train, y_train):
        class_prior_probs= self.prior_probabilities(X_train, y_train)
        mean, std = self.calculate_statistics(X_train, y_train)
        ...
        for i in range(len(X_test)):
            ...
            for j in list(set(y_train)):
                ...
                for index, feat in enumerate(X_test.iloc[i]):
                    ...
                    prob_pred[j] *= self.calculate_probability(feat, mean.iloc[j, index], std.iloc[j, index])
                    #print(prob_pred[j])
                    #print("****************************************************************")
...
print(a.predict(X_test, X_train, y_train))
"""